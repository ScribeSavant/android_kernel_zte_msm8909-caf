...
void DmaAlloc(void)
{
	if (I2CDMABuf_va == NULL) {
		if (g_InputDevice != NULL) {
			...
			I2CDMABuf_va = (u8 *)dma_alloc_coherent(&g_InputDevice->dev,
...
void SetCfb(u8 Cfb)
{
	...
	case _50p: /* / Cfb = 50p */
		...
		RegMask16BitValue(0x1523, (u16)0x0700, (u16)0x0000,
				  ADDRESS_MODE_16BIT);	/* / 0x1523[10:8] = 0x0, Rfb: 180kohm */
		break;

	case _40p: /* / Cfb = 40p */
		RegMask16BitValue(0x1528, (u16)0x0070, (u16)0x0020, ADDRESS_MODE_16BIT);
		RegMask16BitValue(0x1523, (u16)0x0700, (u16)0x0100,
				  ADDRESS_MODE_16BIT);	/* / 0x1523[10:8] = 0x1, Rfb: 225kohm */
		break;

	case _30p: /* / Cfb = 30p */
		RegMask16BitValue(0x1528, (u16)0x0070, (u16)0x0040, ADDRESS_MODE_16BIT);
		RegMask16BitValue(0x1523, (u16)0x0700, (u16)0x0200,
				  ADDRESS_MODE_16BIT);	/* / 0x1523[10:8] = 0x2, Rfb: 300kohm */
		break;
...
s32 IicSegmentReadDataByDbBus(u8 nRegBank, u8 nRegAddr, u8 *pBuf, u16 nSize,
...
s32 IicSegmentReadDataBySmBus(u16 nAddr, u8 *pBuf, u16 nSize, u16 nMaxI2cLengthLimit)
{
	...
	if (g_I2cClient != NULL) {
		while (nLeft > 0) {
			...
			msleep(I2C_SMBUS_WRITE_COMMAND_DELAY_FOR_PLATFORM);
