...
void DrvIcFwLyrGetCustomerFirmwareVersionByDbBus(EmemType_e eEmemType, u16 *pMajor,
...
void DrvIcFwLyrGetMpTestFailChannel(ItoTestMode_e eItoTestMode, u8 *pFailChannel,
