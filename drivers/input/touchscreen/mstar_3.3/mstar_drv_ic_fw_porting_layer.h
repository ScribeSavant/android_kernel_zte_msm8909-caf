...
extern void DrvIcFwLyrGetCustomerFirmwareVersion(u16 *pMajor, u16 *pMinor,
		u8 **ppVersion);
extern void DrvIcFwLyrGetCustomerFirmwareVersionByDbBus(EmemType_e eEmemType, u16 *pMajor,
...
extern void DrvIcFwLyrGetMpTestDataLog(ItoTestMode_e eItoTestMode, u8 *pDataLog,
				       u32 *pLength);
extern void DrvIcFwLyrGetMpTestFailChannel(ItoTestMode_e eItoTestMode, u8 *pFailChannel,
...
extern void DrvIcFwLyrGetTouchPacketAddress(u16 *pDataAddress,
		u16 *pFlagAddress); /* for MSG26xxM/MSG28xx */
